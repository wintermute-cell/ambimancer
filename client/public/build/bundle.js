...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h10 = element("h1");
    			t0 = text("Music Time: ");
    			t1 = text(/*currTime*/ ctx[0]);
    			t2 = space();
    			h11 = element("h1");
    			t3 = text("SFX Time: ");
    			t4 = text(/*currSFXTime*/ ctx[1]);
    			t5 = space();
    			button0 = element("button");
    			button0.textContent = "play music";
    			t7 = space();
    			button1 = element("button");
    			button1.textContent = "stop music";
    			t9 = space();
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*currTime*/ 1) set_data_dev(t1, /*currTime*/ ctx[0]);
    			if (dirty & /*currSFXTime*/ 2) set_data_dev(t4, /*currSFXTime*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function get_motd() {
    		fetch("./motd").then(d => d.text()).then(d => motd = d);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('motd' in $$props) motd = $$props.motd;
    		if ('currTime' in $$props) $$invalidate(0, currTime = $$props.currTime);
    		if ('currSFXTime' in $$props) $$invalidate(1, currSFXTime = $$props.currSFXTime);
    		if ('audFile' in $$props) audFile = $$props.audFile;
    		if ('sfxFile' in $$props) sfxFile = $$props.sfxFile;
    	};
